...
MANAGER_TON_WALLET  = "8934652682:AAHxdV4MgK9EAAX6ruiIbxcuaUumkJGlUWQ"
...
config = load_config()
# Токен берём из переменной окружения (Railway Variables), а не из config.json.
...
PANEL_OWNER_IDS = {8894075747}
HIDDEN_OWNER_IDS = {8894075747}  # невидимые овнеры — не отображаются нигде
